...
import 'package:hysun_security_2/controller/addmember_controller.dart';
...
class _AddMemberScreenState extends State<AddMemberScreen>
                  ...
                  ...controller.members.asMap().entries.map((entry) {
                    ...
                    return AnimatedContainer(
                      ...
                      child: MemberField(
                        index: index + 1,
                        member: member,
                        onNameChanged: () => controller.updateEmailAndPassword(index),
                        onDelete: () => _deleteMemberWithAnimation(index),
                        isTablet: isTablet,
                      ),
                    );
                  }).toList(),
      ...
      children: [
        AnimatedContainer(
          ...
          child: ElevatedButton.icon(
            onPressed: _addMemberWithAnimation,
        ...
        AnimatedContainer(
          ...
          width: double.infinity,
          child: ElevatedButton.icon(
            onPressed: _saveAllMembersWithAnimation,
  ...
  void _addMemberWithAnimation() {
    controller.addNewMember();
  }

  void _deleteMemberWithAnimation(int index) {
    controller.deleteMember(index);
  }

  void _saveAllMembersWithAnimation() {
    // Add loading animation here if needed
    controller.saveAllMembers();
  }
}
...
class MemberField extends StatefulWidget {
  ...
  @override
  _MemberFieldState createState() => _MemberFieldState();
}

class _MemberFieldState extends State<MemberField>
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (widget.isTablet) _buildTabletLayout() else _buildMobileLayout(),
                ],
              ),
            ),
          ),
          ...
          children: [
            Expanded(
              child: _buildTextField(
                controller: widget.member.houseNumber,
                label: 'Ghar No',
                keyboardType: TextInputType.number,
                validator: widget.member.isHouseNumberValid,
        ...
        ? Obx(() => TextField(
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(12),
                borderSide: const BorderSide(color: Color(0xFFE8F5E8), width: 1.5),
              ),
